	...
	execute(bot, message, command, db, lang, language, prefix, args) {
		...
		const helpEmbed = new MessageEmbed()
			...
			.addFields(
				...
				{ name: `💰 ${lang.economyAndProfile}`, value: '`balance`, `daily`, `give`, `inventory`, `pet`, `profile`, `shop`, `vip`, `vote`', inline: true },
				...
				{ name: `${lang.links}`, value: `**[${lang.inviteUs}](https://discordapp.com/oauth2/authorize?&client_id=679041548955942914&scope=bot&permissions=272100438) - [${lang.supportServer}](https://discord.gg/FaUGnB25hF) - [${lang.buyVIP}](https://www.patreon.com/join/suicidekiss)**` },
			);
